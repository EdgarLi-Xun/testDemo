 ...
 * @Description
 * @Author lixun
 * @Date 2020/5/19 13:42
 * @Version 1.0
 **/
public class ExcelToPdf {
    public static void main(String[] args) throws DocumentException, IOException {
        Document document = new Document(PageSize.A4,0,0,50,0);
        PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("E:\\pdf\\excel.pdf"));
        ...
        int colNum = 0;
        try {
            Workbook workbook=Workbook.getWorkbook(new File("E:\\pdf\\excel.xls"));
